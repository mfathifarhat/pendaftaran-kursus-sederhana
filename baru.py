...
while len(kursusKu) < MAX_COURSES and nambah == "1":
    print(f"""
Silahkan masukkan nomor kursus yang ingin anda daftarkan!
...
Kuota   : {kuota5}""")
    ...
    if berhasil == False:
        ...
        if len(kursusKu) < MAX_COURSES and len(kursusKu) > 0:
            nambah = input(
...
print("Terima kasih sudah berkunjung di kursus kami.\n")
